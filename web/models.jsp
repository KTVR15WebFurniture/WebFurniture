        ...
        <section class="container">
            ...
            <form method="POST" class="col-sm-8 col-sm-offset-2" action="addmodel" id="_addproduct" name="addmodel">
                <div class="form-group">
                    ...
                    <%-- таблица составляющих модели --%>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>                            
                                    <td><a href='editPart?edit-part-id=${part.id}&selected-model-id=${selectedModel.id}' name='partId'>${part.serial}</a></td>
                                    <td>${part.price}</td>
                                    <td>${part.duration}</td>
                                    <td>${part.description}</td>
                                    <td><a href="deletePart?delete-part-id=${part.id}&selected-model-id=${selectedModel.id}" >x</a></td>
                                </tr>                                    
                                </c:forEach>
                            </tbody>
                        </table> 
                    ...
                    <div>
                        <label for="comment">№ операции: </label>
                        <input type="text" class="form-control" id="_newpartname" name="newpartname" value="${partToEdit.serial}">
                        <br>

                        <label for="comment">Описание: </label>
                        <textarea class="form-control" rows="5" id="_newpartdescription" name="newpartdescription" value="${partToEdit.description}"></textarea>
